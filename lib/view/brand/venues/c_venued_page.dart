...
import 'package:innetsect/view_model/brand/venues/c_venues_provide.dart';
...
class CVenuedPage extends PageProvideNode {
  final CVenuedProvide _provide = CVenuedProvide();
  CVenuedPage() {
    mProviders.provide(Provider<CVenuedProvide>.value(_provide));
  }
  @override
  Widget buildContent(BuildContext context) {
    return CvenuedContentPage(_provide);
  }
}

class CvenuedContentPage extends StatefulWidget {
  final CVenuedProvide provide;
  CvenuedContentPage(this.provide);
  @override
  _CvenuedContentPageState createState() => _CvenuedContentPageState();
}

class _CvenuedContentPageState extends State<CvenuedContentPage> {
  ...
  Provide<CVenuedProvide> _buildIndexBar(
      BuildContext context, BoxConstraints constraints) {
    return Provide<CVenuedProvide>(
      builder: (BuildContext context, Widget child, CVenuedProvide provide) {

...
class _EditEmailContentState extends State<EditEmailContent> {
  ...
  Widget build(BuildContext context) {
    return new Scaffold(
      appBar: CustomsWidget().customNav(context: context, widget: new Text("换绑邮箱",style: TextStyle(fontSize: ScreenAdapter.size((30)),
          ...
          controller: TextEditingController.fromValue(
              TextEditingValue(
                  ...
                  selection: TextSelection.fromPosition(TextPosition(
                      ...
                      offset: provide.emailText==null?''.length:provide.emailText.length
                  ))
              )),
          enabled: true,

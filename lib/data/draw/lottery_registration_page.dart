...
class LotteryRegistrationPageModel {
  num drawID;
  num shopID;
  String startTime;
  String endTime;
  ...
  factory LotteryRegistrationPageModel.fromJson(Map<String, dynamic> json) {
    return LotteryRegistrationPageModel(
      drawID: json['drawID'],
      shopID: json['shopID'],
...
class LotteryRegistrationPageModelList {
  List<LotteryRegistrationPageModel> list;

  LotteryRegistrationPageModelList(this.list);

  factory LotteryRegistrationPageModelList.fromJson(List json) {
    return LotteryRegistrationPageModelList(
        json.map((item) => LotteryRegistrationPageModel.fromJson((item))).toList());
  }
}
